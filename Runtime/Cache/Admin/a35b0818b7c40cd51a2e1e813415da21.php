...
<body>
	...
	<!-- databales 插件需要js代码 -->	
	<script src="/Public/Admin/Ace/assets/js/jquery.dataTables.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	<script src="/Public/Admin/Ace/mustache\app\views\assets\scripts\tables.js"></script>
					...
					<table id="sample-table-2" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td class="hidden-480">
										<?php if($vo['thumb'] != '' ): ?><img src="/<?php echo ($vo["thumb"]); ?>" alt="thumb" width="70" />	
											<?php else: ?>	
											没有图片<?php endif; ?>
									</td>
									<td>
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons" align="center">
											...
											<a class="green" href="/index.php/Admin/Article/mod/id/<?php echo ($vo["id"]); ?>"> <i class="icon-pencil bigger-130"></i>
											</a>
											&nbsp;
											<a class="red" href="/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">
