...
<body>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
									...
									<td class="f-14 product-brand-manage">
										<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons" align="center">
											...
											<a class="green" href="/tshop/index.php/Admin/Goods/updata/goods_id/<?php echo ($v["id"]); ?>"> <i class="icon-pencil bigger-130"></i>
											</a>
											&nbsp;
											<a class="red" href="/tshop/index.php/Admin/Goods/del/id/<?php echo ($v["id"]); ?>">
	...
	<script>
		...
		$(".btn-info").on("click", function(){
			...
			window.location.href="/tshop/index.php/Admin/Goods/mod/id/" + id;
		});
	</script>