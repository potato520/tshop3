...
<body>
 ...
 window.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");</script>
	...
	<div class="widget-main no-padding">
		<!-- PAGE CONTENT BEGINS -->	
		<form action="/tshop/index.php/Admin/Group/add" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form" id="form" name="form">
	...
	<!-- 弹出提示 -->
	<script src="/tshop/Public/Admin/Ace/assets/js/bootbox.min.js"></script>
