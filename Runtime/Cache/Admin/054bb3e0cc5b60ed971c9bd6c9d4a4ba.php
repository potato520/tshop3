...
<head>
	...
	<style>
			#iframe{ width: 100%; height: 900px; padding-bottom: 50px; background: #fff;}
...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							...
							<li>
								<a href="#">
									<img src="/tshop/Public/Admin/Ace/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />	
									<span class="msg-body">
							...
							<li>
								<a href="#">
									<img src="/tshop/Public/Admin/Ace/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />	
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="#">
									<img src="/tshop/Public/Admin/Ace/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />	
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/tshop/Public/Admin/Ace/assets/avatars/user.jpg" alt="Jason's Photo" />	
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							...
							<li>
								<a href="/tshop/index.php/Admin/Login/loginOut">
									<i class="icon-off"></i>
									Logout
								</a>
							</li>
	...
	<div class="main-container" id="main-container">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						...
						<?php if($vo['pid']==0): ?><a href="<?php echo ($vo["name"]); ?>" class="dropdown-toggle">
							<i class="<?php echo ($vo["icon"]); ?>"></i>
							<span class="menu-text"><?php echo ($vo["title"]); ?></span> <b class="arrow icon-angle-down"></b>
						</a>
						<?php else: ?>
						...
						<ul class="submenu">
						<?php if(is_array($vo["children"])): $i = 0; $__LIST__ = $vo["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
								<a href="/tshop/index.php/Admin/<?php echo ($v['name']); ?>" target="main">
			...
			<div class="main-content">
				<iframe src="" frameborder="0" id="iframe" name="main"></iframe>
	...
	<!--[if IE]>	
	<script type="text/javascript">
 window.jQuery || document.write("<script src='/tshop/Public/Admin/Ace/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");</script>
	<![endif]-->	
	...
	<!--[if lte IE 8]>	
	<script src="/tshop/Public/Admin/Ace/assets/js/excanvas.min.js"></script>
	<![endif]-->	
	...
	<script src="/tshop/Public/Admin/Ace/assets/js/jquery.slimscroll.min.js"></script>
	<script src="/tshop/Public/Admin/Ace/assets/js/jquery.easy-pie-chart.min.js"></script>
	<script src="/tshop/Public/Admin/Ace/assets/js/jquery.sparkline.min.js"></script>
	<script src="/tshop/Public/Admin/Ace/assets/js/flot/jquery.flot.min.js"></script>
	<script src="/tshop/Public/Admin/Ace/assets/js/flot/jquery.flot.pie.min.js"></script>
	<script src="/tshop/Public/Admin/Ace/assets/js/flot/jquery.flot.resize.min.js"></script>
