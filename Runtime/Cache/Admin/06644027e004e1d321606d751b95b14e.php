...
<body>
  ...
  function del_pic(id){
  	var url = '/tshop/index.php/Admin/Goods/delpic'; //服务器接收数据的地址
    $.post(url, { "id": id },
      function(data){
       if (data.status == 1) {
        $("#pic_"+id).remove();
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/tshop/index.php/Admin/Goods/updata" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
