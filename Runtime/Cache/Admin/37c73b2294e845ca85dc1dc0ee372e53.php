...
<body>
  ...
  function add_pic () {
	...
	<script>
	function showAttr(type_id){
		var url = "/tshop/index.php/Admin/Attr/getAttrById";
		$.post(url, {"type_id" : type_id}, function(data){
			// console.log(data);
...
<script>	
	...
	function show_cate(cateid, id){
		// 商品分类id
		// alert(cateid);
		 var url = '/tshop/index.php/Admin/goodscategory/getCateById';
    // 通过cateid获取所有的子级分类
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/tshop/index.php/Admin/Goods/add" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
