		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="widget-main no-padding">
					<!-- PAGE CONTENT BEGINS -->	
					<form action="/index.php/Admin/Goodscategory/add" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form" id="form" name="form">

						<div class="form-group">
							<label class="col-sm-1 control-label no-padding-right" for="form-field-1">分类名称</label>

							<div class="col-sm-7">
								<input type="text"  id="title" placeholder="分类名称" class="col-xs-10 col-sm-5" name="cate_name" />	
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" name="pid" id="form-field-select-1">
									...
									<?php if(is_array($cateInfo)): $i = 0; $__LIST__ = $cateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cat["id"]); ?>"><?php echo (str_repeat("----",$cat["cate_level"])); echo ($cat["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
