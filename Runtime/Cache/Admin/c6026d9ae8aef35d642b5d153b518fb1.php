...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							...
							<li>
								<a href="#">
									<img src="/Public/Admin/Ace/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />	
									<span class="msg-body">
							...
							<li>
								<a href="#">
									<img src="/Public/Admin/Ace/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />	
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="#">
									<img src="/Public/Admin/Ace/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />	
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/Public/Admin/Ace/assets/avatars/user.jpg" alt="Jason's Photo" />	
	...
	<div class="main-container" id="main-container">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						...
						<?php if(is_array($vo["children"])): $i = 0; $__LIST__ = $vo["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
								<a href="/index.php/Admin/<?php echo ($v['name']); ?>" target="main">
	...
	<!--[if IE]>	
	<script type="text/javascript">
 window.jQuery || document.write("<script src='/Public/Admin/Ace/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");</script>
	<![endif]-->	
	...
	<!--[if lte IE 8]>	
	<script src="/Public/Admin/Ace/assets/js/excanvas.min.js"></script>
	<![endif]-->	
	...
	<script src="/Public/Admin/Ace/assets/js/jquery.slimscroll.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/jquery.easy-pie-chart.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/jquery.sparkline.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/flot/jquery.flot.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/flot/jquery.flot.pie.min.js"></script>
	<script src="/Public/Admin/Ace/assets/js/flot/jquery.flot.resize.min.js"></script>
