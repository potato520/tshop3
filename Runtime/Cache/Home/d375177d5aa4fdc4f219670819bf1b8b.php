...
<head>
    ...
    <link rel="stylesheet" href="/tshop/Public/Home/style/list.css" type="text/css" />
</head>
...
<div id="main">
    ...
    <div class="container">
<form id="filterForm" name="form1" method="get" action="/tshop/index.php/Home/Course/index">
            ...
            <div class="course-list">
                <div class="js-course-lists">
                    ...
                    <?php if(is_array($data2)): foreach($data2 as $k=>$vo): ?><li class="course-one">
                            <a target="_blank" href="/tshop/index.php/Home/CourseList/index/id/<?php echo ($vo["id"]); ?>" target="_self">
                                <div class="course-list-img">
                                    <img width="240" height="135" alt="JavaScript入门篇" src="/tshop/<?php echo ($vo["thumb"]); ?>"></div>
                                <h5>
