...
<head>
  ...
  -->
  <link rel="stylesheet" href="/tshop/Public/Home/style/css2.css" type="text/css" />
        ...
        <div class="outline-list">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="chapter clearfix ">
              ...
              <div class="chapter-bd l">
                <h5 class="name"><a href="/tshop/index.php/Home/CourseList/video/id/<?php echo ($vo["id"]); ?>" target="_blank" style="cursor:pointer;"><?php echo ($vo["class_title"]); ?></a></h5>
